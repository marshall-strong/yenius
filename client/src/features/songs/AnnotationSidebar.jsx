...
const AnnotationSidebar = () => (
  <div className="AnnotationSidebar" referent="current_referent">
          ...
          >
            ...
            >
              <p>
                ...
                Kanye lives) across the United States every year to honor Puerto
                Ricans living in the U.S.. Marina Del Rey is home to over 5,000
                boats and is situated next to Los Angeles International Airport.
              </p>

              <p>
                Kanye is using both the parade and the marina to describe how
                his whip is “floatin.” This verb is often used by rappers to
                describe the feeling of cruising in a smooth luxury car. Parades
                have “floats” in them; “boats” float. Drake uses “floating” in
                this way on the hook from{" "}
                <a
    ...
    'square_button--depress_on_click': !ctrl.pyonged(),
          ...
          >
            <annotation-share-menu annotation="annotation" variants="variants">
